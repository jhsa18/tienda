...
import com.unab.tienda.Models.Administrador;
import com.unab.tienda.Security.Hash;
import com.unab.tienda.Dao.AdministradorDao;
import com.unab.tienda.Service.AdministradorService;
...
public class AdministradorController {
    ...
    @PostMapping(value = "/")
    @ResponseBody
    public ResponseEntity<Administrador> agregar(@RequestHeader("clave") String clave,
            @RequestHeader("usuario") String usuario, @Valid @RequestBody Administrador administrador) {
    ...
    public ResponseEntity<Administrador> eliminar(@PathVariable String id, @RequestHeader("clave") String clave,
    ...
    @PutMapping(value = "/")
    @ResponseBody
    public ResponseEntity<Administrador> editar(@RequestHeader("clave") String clave,
            @RequestHeader("usuario") String usuario, @Valid @RequestBody Administrador administrador) {
        Administrador admon1 = new Administrador();
        admon1 = administradorDao.login(usuario, Hash.sha1(clave));
        if (admon1 != null) {
    ...
    @GetMapping("/list")
    @ResponseBody
    public ResponseEntity<List<Administrador>> consultarTodo(@RequestHeader("clave") String clave,
            @RequestHeader("usuario") String usuario) {
    ...
    @GetMapping("/list/{id}")
    @ResponseBody
    public ResponseEntity<Administrador> consultaPorId(@PathVariable String id, @RequestHeader("clave") String clave,
            @RequestHeader("usuario") String usuario) {
        Administrador administrador = new Administrador();
        administrador = administradorDao.login(usuario, Hash.sha1(clave));
        if (administrador != null) {
